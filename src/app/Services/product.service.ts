...
export class ProductService {
  ...
  URL='http://localhost:3000'
   _getProducturl=`${this.URL}/bachatbazzar/product/products`

   _getproducturlbyid=`${this.URL}/bachatbazzar/product/products`

   _postproduct=`${this.URL}/bachatbazzar/product/products/${this.userId}`

   _updateproducturl=`${this.URL}/bachatbazzar/product/products/${this.userId}/6304f22ad4ed4711edf6d8aa`

   _deleteproduct=`${this.URL}/bachatbazzar/product/products/${this.userId}/6304f22ad4ed4711edf6d8aa`
