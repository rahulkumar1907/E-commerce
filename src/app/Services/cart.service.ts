...
export class CartService {
 ...
 URL='http://localhost:3000'
  _addtocart = `${this.URL}/bachatbazzar/cart/users/${this.userId}/cart`;

  _updatecart = `${this.URL}/bachatbazzar/cart/users/${this.userId}/cart`;

  _deletecart = `${this.URL}/bachatbazzar/cart/users/${this.userId}/cart`;

  _getcart = `${this.URL}/bachatbazzar/cart/users/${this.userId}/cart`;
